...
import static com.ciji.serenity.enums.Command.REFRESH_CHARACTER_DATA;

@Component
@Slf4j
@AllArgsConstructor
public class RefreshCharacterDataCommand implements SerenityCommand {

    @Override
    public void register(long applicationId, RestClient restClient) {
        ApplicationCommandRequest commandRequest = ApplicationCommandRequest.builder()
                .name(REFRESH_CHARACTER_DATA.getCommand())
                .description(REFRESH_CHARACTER_DATA.getShortDesc())
