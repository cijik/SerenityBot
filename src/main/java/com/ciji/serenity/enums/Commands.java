...
public enum Commands {
    ...
    Map.of("name", "Name of the character to add", 
    ...
    Map.of("name", "Name of the character to retrieve as written when they were added (case insensitive)")),
    ...
    "", 
    Map.of("name", "Name of the character to update", 
    ...
    Map.of("name", "Name of the character to remove as written when they were added (case insensitive)")),
    ...
    Map.of("name", "Name of the character sheet to read from", 
    ...
    Map.of("roll", "The roll expression")),
    ...
    Map.of("command", "Specific command to get info about")),
